...
2.. Projects should configure a subset of unit tests as 'fast tests', which should have a very quick runtime, and should always run them after making code changes to ensure nothing is broken.
